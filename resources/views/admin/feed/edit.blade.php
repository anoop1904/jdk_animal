                    ...
                    <form action="{{ route('feeds.update', $feed->id) }}" method="POST">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6 col-sm-12">
                                ...
                                <input type="text" class="form-control" id="en_name" name="en_name" value="{{$feed->en_name}}" placeholder="Enter feed name">
                            </div>     
                            <div class="form-group col-md-6 col-sm-12">
                                <label for="tg_name">Feed Name in telugu</label>
                                <input type="text" class="form-control" id="tg_name" name="tg_name" value="{{$feed->tg_name}}" placeholder="Enter feed name">
                            </div>             
                        </div>          
                        <div class="form-row">
                            <div class="form-group col-md-6 col-sm-12">
